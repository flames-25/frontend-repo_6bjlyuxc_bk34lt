      ...
      <nav className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          <a href="#home" className="font-extrabold tracking-tight text-gray-900 text-lg">
            <span className="bg-gradient-to-r from-indigo-600 to-blue-600 bg-clip-text text-transparent">Alyasa Kelana Makarim</span>
          </a>
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <div className="flex items-center gap-3 pl-3 border-l border-black/10">
              <a href="https://www.instagram.com/kelanaverse/" target="_blank" rel="noreferrer" aria-label="Instagram" className="text-gray-700 hover:text-gray-900"><Instagram className="h-5 w-5" /></a>
            </div>
          </div>
